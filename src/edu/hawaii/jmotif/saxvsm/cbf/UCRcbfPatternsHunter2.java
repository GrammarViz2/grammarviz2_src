 ...
 * 
 */
public class UCRcbfPatternsHunter2 extends UCRGenericClassifier {

  // prefix for all of the output
  private static final String TRAINING_DATA = "digits_normalized_reduced_200.csv";

  // SAX parameters to use
  //
  private static final int[][] params = { { 210, 20, 3, NOREDUCTION } };
