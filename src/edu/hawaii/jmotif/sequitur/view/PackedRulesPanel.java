...
import edu.hawaii.jmotif.sequitur.view.table.PrunedRulesTableColumns;
import edu.hawaii.jmotif.sequitur.view.table.PrunedRulesTableModel;
...
public class PackedRulesPanel extends JPanel implements ListSelectionListener,
  ...
  public PackedRulesPanel() {
    ...
    TableRowSorter<PrunedRulesTableModel> sorter = new TableRowSorter<PrunedRulesTableModel>(packedTableModel);
